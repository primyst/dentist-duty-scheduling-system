...
const AdminPanel = () => {
  ...
  const autoAssign = () => {
    ...
    // Smart AI-like notification
    if (requests["Dr Abdulqudus"]?.includes("Friday"))
      newNotifs.push("AI Suggestion: Dr Abdulqudus prefers to go to mosque on Friday — shift excluded.");
  ...
  return (
    <div>
      <Header totalStaff={dentists.length} totalShifts={totalShifts} requests={Object.keys(requests).length} />
      <div className="p-6">
        <div className="flex gap-2 mb-4">
          <button className="bg-blue-500 text-white px-4 py-2 rounded" onClick={autoAssign}>
            Auto Assign
          </button>
